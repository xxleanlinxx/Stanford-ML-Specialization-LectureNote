...
- [[KP-06 - Attention 機制與 Transformer]] — SwiGLU 在 FFN 中的使用
- [[KP-04 - 正則化技術]] — BN/LN 與激活函數的搭配

## 🔗 相關課程筆記

- [[C2-W2 - Neural Network Training]] — Sigmoid、ReLU、選擇指南
- [[C2-W1 - Neural Networks]] — 激活函數在前向傳播中的角色
